                    ...
                    <form action="{{ url('update-product/'.$product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control border px-2 " name="shopify_link" value="{{ $product->shopify_link }}" >
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control border px-2 " name="amazon_link" value="{{ $product->amazon_link }}" >
